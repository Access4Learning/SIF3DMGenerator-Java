...
@XmlType(name = "assessmentRubricType", namespace = "http://www.sifassociation.org/datamodel/na/3.2", propOrder = {
    "rubricVersion",
    "rubricPublishDate",
    ...
    extends GOtherSIFType
{
    ...
    @XmlElementRef(name = "rubricVersion", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
    protected JAXBElement<String> rubricVersion;
    @XmlElementRef(name = "rubricPublishDate", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> rubricPublishDate;
    @XmlElementRef(name = "rubricIdentifierList", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "scoringGuideReference", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
    protected JAXBElement<String> scoringGuideReference;
    @XmlElementRef(name = "scoreList", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
    ...
    public static class ScoreList {
        ...
        public static class Score {
            ...
            @XmlElementRef(name = "scoreCode", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
            protected JAXBElement<String> scoreCode;
            @XmlElementRef(name = "scoreCodeDefinition", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
            protected JAXBElement<String> scoreCodeDefinition;
            @XmlElement(namespace = "http://www.sifassociation.org/datamodel/na/3.2", required = true)
            protected BigDecimal scoreValue;
            @XmlElementRef(name = "scoreDescriptionList", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
            protected JAXBElement<AssessmentRubricType.ScoreList.Score.ScoreDescriptionList> scoreDescriptionList;
            @XmlElementRef(name = "scoreCommentList", namespace = "http://www.sifassociation.org/datamodel/na/3.2", type = JAXBElement.class, required = false)
