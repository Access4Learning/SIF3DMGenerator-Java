...
@XmlType(name = "gAssociationType", namespace = "http://www.sifassociation.org/datamodel/na/3.3")
@XmlSeeAlso({
    AssessmentItemAssociationType.class,
    StudentActivityParticipationType.class,
    LearningStandardAssociationType.class,
