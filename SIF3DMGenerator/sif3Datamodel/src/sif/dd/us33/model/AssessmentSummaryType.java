...
@XmlType(name = "assessmentSummaryType", namespace = "http://www.sifassociation.org/datamodel/na/3.3", propOrder = {
    "summaryContext",
    "columnList",
    "rowList"
})
    ...
    extends GSIFReportType
{
    ...
    public static class SummaryContext {
        ...
        @XmlElement(name = "State", namespace = "http://www.sifassociation.org/datamodel/na/3.3")
        protected Object state;
        @XmlElement(name = "LEA", namespace = "http://www.sifassociation.org/datamodel/na/3.3")
        protected Object lea;
        @XmlElement(name = "School", namespace = "http://www.sifassociation.org/datamodel/na/3.3")
