...
@XmlType(name = "assessmentScoreTableType", namespace = "http://www.sifassociation.org/datamodel/na/3.3", propOrder = {
    "scoreTableVersion",
    ...
    extends GOtherSIFType
{
    ...
    public static class ScoreValueList {
        ...
        public static class ScoreValue {
            ...
            @XmlElementRef(name = "passFailIndicator", namespace = "http://www.sifassociation.org/datamodel/na/3.3", type = JAXBElement.class, required = false)
            protected JAXBElement<String> passFailIndicator;
            @XmlElementRef(name = "feedbackList", namespace = "http://www.sifassociation.org/datamodel/na/3.3", type = JAXBElement.class, required = false)
            ...
            public static class FeedbackList {
                ...
                public static class Feedback {
                    ...
                    @XmlElementRef(name = "source", namespace = "http://www.sifassociation.org/datamodel/na/3.3", type = JAXBElement.class, required = false)
