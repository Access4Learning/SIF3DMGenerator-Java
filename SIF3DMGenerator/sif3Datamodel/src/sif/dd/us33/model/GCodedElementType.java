...
@XmlType(name = "gCodedElementType", namespace = "http://www.sifassociation.org/datamodel/na/3.3", propOrder = {
    "code",
    "hexValue",
    "hexValueDashed",
    "otherCodeList"
...
@XmlSeeAlso({
    sif.dd.us33.model.DisciplineIncidentType.IncidentCategoryList.IncidentCategory.class,
