 ...
 *       &lt;sequence>
 *         &lt;element name="partyRefId" type="{http://www.sifassociation.org/datamodel/na/3.3}gGenericRefIdPointerType"/>
 *         &lt;element name="addressRefId" type="{http://www.sifassociation.org/datamodel/na/3.3}gRefIdPointerType"/>
 *         &lt;element name="addressType" type="{http://www.sifassociation.org/datamodel/na/3.3}gCodedElementType"/>
 *         &lt;element name="addressRole" type="{http://www.sifassociation.org/datamodel/na/3.3}gAddressRoleType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "gPartyAddressRelationType", namespace = "http://www.sifassociation.org/datamodel/na/3.3", propOrder = {
    "partyRefId",
    "addressRefId",
    "addressType",
    "addressRole"
...
@XmlSeeAlso({
    PartyAddressAssociationType.class
})
