...
/**
 * <p>Java class for xLanguageCodeType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="xLanguageCodeType">
 ...
 * 
 */
@XmlType(name = "xLanguageCodeType", namespace = "http://www.sifassociation.org/datamodel/na/3.3")
@XmlEnum
public enum XLanguageCodeType {
    ...
    public static XLanguageCodeType fromValue(String v) {
        for (XLanguageCodeType c: XLanguageCodeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
