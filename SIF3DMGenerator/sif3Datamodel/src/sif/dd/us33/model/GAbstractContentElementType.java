...
@XmlType(name = "gAbstractContentElementType", namespace = "http://www.sifassociation.org/datamodel/na/3.3", propOrder = {
    "xmlData",
    "textData",
    "binaryData",
    "reference"
...
public class GAbstractContentElementType {
    ...
    @XmlElementRef(name = "xmlData", namespace = "http://www.sifassociation.org/datamodel/na/3.3", type = JAXBElement.class, required = false)
    protected JAXBElement<GAbstractContentElementType.XmlData> xmlData;
    @XmlElementRef(name = "textData", namespace = "http://www.sifassociation.org/datamodel/na/3.3", type = JAXBElement.class, required = false)
    protected JAXBElement<GAbstractContentElementType.TextData> textData;
    @XmlElementRef(name = "binaryData", namespace = "http://www.sifassociation.org/datamodel/na/3.3", type = JAXBElement.class, required = false)
