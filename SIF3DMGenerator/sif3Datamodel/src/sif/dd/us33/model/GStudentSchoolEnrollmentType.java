 ...
 *         &lt;element name="membershipType" type="{http://www.sifassociation.org/datamodel/na/3.3}gLaxCodedElementType" minOccurs="0"/>
 ...
 *         &lt;element name="entryType" type="{http://www.sifassociation.org/datamodel/na/3.3}gEntryTypeType"/>
 *         &lt;element name="yearGroup" type="{http://www.sifassociation.org/datamodel/na/3.3}gYearGroupType" minOccurs="0"/>
 *         &lt;element name="homeRoomRefId" type="{http://www.sifassociation.org/datamodel/na/3.3}gRefIdPointerType" minOccurs="0"/>
 *         &lt;element name="advisor" type="{http://www.sifassociation.org/datamodel/na/3.3}gGenericRefIdPointerType" minOccurs="0"/>
 *         &lt;element name="counselor" type="{http://www.sifassociation.org/datamodel/na/3.3}gGenericRefIdPointerType" minOccurs="0"/>
 ...
 *         &lt;element name="exitStatus" type="{http://www.sifassociation.org/datamodel/na/3.3}gExitStatusType" minOccurs="0"/>
 *         &lt;element name="exitType" type="{http://www.sifassociation.org/datamodel/na/3.3}gExitTypeType" minOccurs="0"/>
 *         &lt;element name="recordClosureReason" type="{http://www.sifassociation.org/datamodel/na/3.3}gRecordClosureReasonType" minOccurs="0"/>
 *         &lt;element name="destinationSchool" type="{http://www.sifassociation.org/datamodel/na/3.3}gLocalIdType" minOccurs="0"/>
 *         &lt;element name="promotionStatus" type="{http://www.sifassociation.org/datamodel/na/3.3}gPromotionStatusType" minOccurs="0"/>
 *         &lt;element name="fte" type="{http://www.sifassociation.org/datamodel/na/3.3}gFractionDecimal" minOccurs="0"/>
 *         &lt;element name="ftptStatus" type="{http://www.sifassociation.org/datamodel/na/3.3}gFullTimeStatusType" minOccurs="0"/>
 *         &lt;element name="residencyStatus" type="{http://www.sifassociation.org/datamodel/na/3.3}gResidencyStatusType" minOccurs="0"/>
 *         &lt;element name="acceptableUsePolicy" type="{http://www.sifassociation.org/datamodel/na/3.3}gYesNoUnknownType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "gStudentSchoolEnrollmentType", namespace = "http://www.sifassociation.org/datamodel/na/3.3", propOrder = {
    "studentRefId",
    "schoolRefId",
    "membershipType",
    "schoolYear",
...
@XmlSeeAlso({
    StudentSchoolAssociationType.class
})
