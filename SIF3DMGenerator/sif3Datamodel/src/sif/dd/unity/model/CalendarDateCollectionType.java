 ...
 *       &lt;sequence>
 *         &lt;element name="CalendarDate" type="{http://www.sifassociation.org/datamodel/na/4.x}CalendarDateType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CalendarDateCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "calendarDate"
})
public class CalendarDateCollectionType {

    @XmlElement(name = "CalendarDate", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
