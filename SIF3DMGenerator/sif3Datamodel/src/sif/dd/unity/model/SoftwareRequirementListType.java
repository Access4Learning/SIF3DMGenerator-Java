 ...
 *       &lt;sequence>
 *         &lt;element name="SoftwareRequirement" type="{http://www.sifassociation.org/datamodel/na/4.x}SoftwareRequirementType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SoftwareRequirementListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "softwareRequirement"
})
public class SoftwareRequirementListType {

    @XmlElement(name = "SoftwareRequirement", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
