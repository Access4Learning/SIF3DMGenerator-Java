...
/**
 * <p>Java class for ServiceProviderTypeType complex type.
 * 
...
@XmlType(name = "ServiceProviderTypeType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "code",
    "otherCodeList"
})
public class ServiceProviderTypeType {

    @XmlElement(name = "Code", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
    protected ServiceProviderTypeType.Code code;
     ...
     * @return
     *     possible object is
     *     {@link ServiceProviderTypeType.Code }
     *     
     */
    public ServiceProviderTypeType.Code getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(ServiceProviderTypeType.Code value) {
        this.code = value;
    }
