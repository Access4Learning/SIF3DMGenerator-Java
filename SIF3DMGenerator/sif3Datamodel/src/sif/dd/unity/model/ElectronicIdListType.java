 ...
 *       &lt;sequence>
 *         &lt;element name="ElectronicId" type="{http://www.sifassociation.org/datamodel/na/4.x}ElectronicIdType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ElectronicIdListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "electronicId"
})
public class ElectronicIdListType {

    @XmlElement(name = "ElectronicId", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
