 ...
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://www.sifassociation.org/datamodel/na/4.x}OldAddressType">
...
@XmlType(name = "AddressListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "address"
})
public class AddressListType {

    @XmlElement(name = "Address", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
