 ...
 *       &lt;sequence>
 *         &lt;element name="AssessmentPackage" type="{http://www.sifassociation.org/datamodel/na/4.x}AssessmentPackageType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AssessmentPackageCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "assessmentPackage"
})
public class AssessmentPackageCollectionType {

    @XmlElement(name = "AssessmentPackage", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
