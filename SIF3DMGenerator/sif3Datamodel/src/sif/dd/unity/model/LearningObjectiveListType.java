...
/**
 * <p>Java class for LearningObjectiveListType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LearningObjectiveListType">
 *   &lt;complexContent>
...
@XmlType(name = "LearningObjectiveListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "learningObjective"
})
public class LearningObjectiveListType {

    @XmlElement(name = "LearningObjective", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
