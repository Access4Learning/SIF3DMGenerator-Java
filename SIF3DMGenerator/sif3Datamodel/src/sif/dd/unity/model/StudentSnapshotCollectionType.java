 ...
 *       &lt;sequence>
 *         &lt;element name="StudentSnapshot" type="{http://www.sifassociation.org/datamodel/na/4.x}StudentSnapshotType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentSnapshotCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "studentSnapshot"
})
public class StudentSnapshotCollectionType {

    @XmlElement(name = "StudentSnapshot", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
