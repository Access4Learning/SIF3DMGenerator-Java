 ...
 *       &lt;sequence>
 *         &lt;element name="StudentGrade" type="{http://www.sifassociation.org/datamodel/na/4.x}StudentGradeType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentGradeCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "studentGrade"
})
public class StudentGradeCollectionType {

    @XmlElement(name = "StudentGrade", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
