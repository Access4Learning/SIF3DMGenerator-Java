 ...
 *       &lt;sequence>
 *         &lt;element name="PersonRoleAssociation" type="{http://www.sifassociation.org/datamodel/na/4.x}PersonRoleAssociationType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PersonRoleAssociationCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "personRoleAssociation"
})
public class PersonRoleAssociationCollectionType {

    @XmlElement(name = "PersonRoleAssociation", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
