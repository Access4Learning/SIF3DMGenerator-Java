 ...
 *       &lt;sequence>
 *         &lt;element name="StaffAssignment" type="{http://www.sifassociation.org/datamodel/na/4.x}StaffAssignmentType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StaffAssignmentCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "staffAssignment"
})
public class StaffAssignmentCollectionType {

    @XmlElement(name = "StaffAssignment", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
