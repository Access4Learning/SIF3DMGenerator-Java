 ...
 *         &lt;element name="RecognitionList" type="{http://www.sifassociation.org/datamodel/na/4.x}RecognitionListType" minOccurs="0"/>
 ...
 *       &lt;attribute name="StudentActivityInfoRefId" use="required" type="{http://www.sifassociation.org/datamodel/na/4.x}IdRefType" />
...
@XmlType(name = "StudentActivityParticipationType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
...
public class StudentActivityParticipationType {
    ...
    @XmlElement(name = "ParticipationComment", namespace = "http://www.sifassociation.org/datamodel/na/4.x", nillable = true)
    protected String participationComment;
    ...
    @XmlElement(name = "RecognitionList", namespace = "http://www.sifassociation.org/datamodel/na/4.x", nillable = true)
    ...
    @XmlAttribute(name = "StudentActivityInfoRefId", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
