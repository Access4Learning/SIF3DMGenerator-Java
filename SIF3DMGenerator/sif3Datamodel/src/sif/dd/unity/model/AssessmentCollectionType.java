 ...
 *       &lt;sequence>
 *         &lt;element name="Assessment" type="{http://www.sifassociation.org/datamodel/na/4.x}AssessmentType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AssessmentCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "assessment"
})
public class AssessmentCollectionType {

    @XmlElement(name = "Assessment", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
