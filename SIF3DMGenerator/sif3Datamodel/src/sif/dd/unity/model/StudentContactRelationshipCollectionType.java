 ...
 *       &lt;sequence>
 *         &lt;element name="StudentContactRelationship" type="{http://www.sifassociation.org/datamodel/na/4.x}StudentContactRelationshipType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentContactRelationshipCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "studentContactRelationship"
})
public class StudentContactRelationshipCollectionType {

    @XmlElement(name = "StudentContactRelationship", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
