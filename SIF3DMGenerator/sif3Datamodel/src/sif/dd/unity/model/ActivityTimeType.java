...
@XmlType(name = "ActivityTimeType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "creationDate",
    "duration",
    "startDate",
    "finishDate",
...
public class ActivityTimeType {
    ...
    @XmlElement(name = "FinishDate", namespace = "http://www.sifassociation.org/datamodel/na/4.x", nillable = true)
    @XmlSchemaType(name = "date")
