...
@XmlType(name = "AlternateIdentificationCodeListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "alternateIdentificationCode"
})
public class AlternateIdentificationCodeListType {

    @XmlElement(name = "AlternateIdentificationCode", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
