 ...
 *       &lt;sequence>
 *         &lt;element name="HoldInfo" type="{http://www.sifassociation.org/datamodel/na/4.x}HoldInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "HoldInfoListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "holdInfo"
})
public class HoldInfoListType {

    @XmlElement(name = "HoldInfo", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
