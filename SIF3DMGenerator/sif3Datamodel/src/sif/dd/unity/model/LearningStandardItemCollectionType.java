 ...
 *       &lt;sequence>
 *         &lt;element name="LearningStandardItem" type="{http://www.sifassociation.org/datamodel/na/4.x}LearningStandardItemType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LearningStandardItemCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "learningStandardItem"
})
public class LearningStandardItemCollectionType {

    @XmlElement(name = "LearningStandardItem", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
