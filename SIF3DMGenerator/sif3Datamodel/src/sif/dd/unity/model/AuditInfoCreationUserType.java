...
/**
 * <p>Java class for AuditInfoCreationUserType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AuditInfoCreationUserType">
 *   &lt;complexContent>
...
@XmlType(name = "AuditInfoCreationUserType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "userId"
})
public class AuditInfoCreationUserType {

    @XmlElement(name = "UserId", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
