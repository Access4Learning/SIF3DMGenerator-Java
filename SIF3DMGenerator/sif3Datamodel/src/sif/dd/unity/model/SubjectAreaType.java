...
@XmlType(name = "SubjectAreaType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "code",
    "otherCodeList"
})
public class SubjectAreaType {
    ...
    protected SubjectAreaType.Code code;
     ...
     * @return
     *     possible object is
     *     {@link SubjectAreaType.Code }
     *     
     */
    public SubjectAreaType.Code getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(SubjectAreaType.Code value) {
        this.code = value;
    }
