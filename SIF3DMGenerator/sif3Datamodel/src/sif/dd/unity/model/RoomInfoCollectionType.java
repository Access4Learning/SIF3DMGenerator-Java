 ...
 *       &lt;sequence>
 *         &lt;element name="RoomInfo" type="{http://www.sifassociation.org/datamodel/na/4.x}RoomInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RoomInfoCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "roomInfo"
})
public class RoomInfoCollectionType {

    @XmlElement(name = "RoomInfo", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
