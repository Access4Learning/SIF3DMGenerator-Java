 ...
 *       &lt;sequence>
 *         &lt;element name="SectionInfo" type="{http://www.sifassociation.org/datamodel/na/4.x}SectionInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SectionInfoCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "sectionInfo"
})
public class SectionInfoCollectionType {

    @XmlElement(name = "SectionInfo", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
