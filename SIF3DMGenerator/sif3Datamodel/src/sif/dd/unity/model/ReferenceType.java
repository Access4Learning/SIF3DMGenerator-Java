...
@XmlType(name = "ReferenceType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "url"
})
public class ReferenceType {

    @XmlElement(name = "URL", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
