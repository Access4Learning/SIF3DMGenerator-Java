 ...
 *         &lt;element name="ListedStatus" type="{http://www.w3.org/2001/XMLSchema}token" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PhoneNumberType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "number",
    "extension",
    "listedStatus"
})
@XmlSeeAlso({
    sif.dd.unity.model.PhoneNumberListType.PhoneNumber.class
})
public class PhoneNumberType {

    @XmlElement(name = "Number", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String number;
    @XmlElement(name = "Extension", namespace = "http://www.sifassociation.org/datamodel/na/4.x", nillable = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String extension;
    @XmlElement(name = "ListedStatus", namespace = "http://www.sifassociation.org/datamodel/na/4.x", nillable = true)
