 ...
 *       &lt;sequence>
 *         &lt;element name="SchoolCourseInfo" type="{http://www.sifassociation.org/datamodel/na/4.x}SchoolCourseInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SchoolCourseInfoCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "schoolCourseInfo"
})
public class SchoolCourseInfoCollectionType {

    @XmlElement(name = "SchoolCourseInfo", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
