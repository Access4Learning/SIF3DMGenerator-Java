 ...
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://www.sifassociation.org/datamodel/na/4.x}PhoneNumberType">
...
@XmlType(name = "PhoneNumberListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "phoneNumber"
})
public class PhoneNumberListType {

    @XmlElement(name = "PhoneNumber", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
