...
@XmlType(name = "LanguageOfInstructionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "code",
    "otherCodeList"
})
public class LanguageOfInstructionType {
    ...
    protected LanguageOfInstructionType.Code code;
     ...
     * @return
     *     possible object is
     *     {@link LanguageOfInstructionType.Code }
     *     
     */
    public LanguageOfInstructionType.Code getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(LanguageOfInstructionType.Code value) {
        this.code = value;
    }
