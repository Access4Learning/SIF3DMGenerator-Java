 ...
 *       &lt;sequence>
 *         &lt;element name="LearningStandardDocument" type="{http://www.sifassociation.org/datamodel/na/4.x}LearningStandardDocumentType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LearningStandardDocumentCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "learningStandardDocument"
})
public class LearningStandardDocumentCollectionType {

    @XmlElement(name = "LearningStandardDocument", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
