 ...
 *       &lt;sequence>
 *         &lt;element name="CalendarSummary" type="{http://www.sifassociation.org/datamodel/na/4.x}CalendarSummaryType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CalendarSummaryCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "calendarSummary"
})
public class CalendarSummaryCollectionType {

    @XmlElement(name = "CalendarSummary", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
