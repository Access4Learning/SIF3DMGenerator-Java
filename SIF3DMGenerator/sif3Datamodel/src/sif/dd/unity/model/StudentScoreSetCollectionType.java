 ...
 *       &lt;sequence>
 *         &lt;element name="StudentScoreSet" type="{http://www.sifassociation.org/datamodel/na/4.x}StudentScoreSetType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentScoreSetCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "studentScoreSet"
})
public class StudentScoreSetCollectionType {

    @XmlElement(name = "StudentScoreSet", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
