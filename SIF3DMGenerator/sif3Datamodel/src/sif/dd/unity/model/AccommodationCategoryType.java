...
@XmlType(name = "AccommodationCategoryType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "code",
    "otherCodeList"
})
public class AccommodationCategoryType {
    ...
    protected AccommodationCategoryType.Code code;
     ...
     * @return
     *     possible object is
     *     {@link AccommodationCategoryType.Code }
     *     
     */
    public AccommodationCategoryType.Code getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(AccommodationCategoryType.Code value) {
        this.code = value;
    }
