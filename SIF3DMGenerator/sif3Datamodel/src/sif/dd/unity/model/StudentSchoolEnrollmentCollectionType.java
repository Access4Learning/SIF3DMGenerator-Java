 ...
 *       &lt;sequence>
 *         &lt;element name="StudentSchoolEnrollment" type="{http://www.sifassociation.org/datamodel/na/4.x}StudentSchoolEnrollmentType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentSchoolEnrollmentCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "studentSchoolEnrollment"
})
public class StudentSchoolEnrollmentCollectionType {

    @XmlElement(name = "StudentSchoolEnrollment", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
