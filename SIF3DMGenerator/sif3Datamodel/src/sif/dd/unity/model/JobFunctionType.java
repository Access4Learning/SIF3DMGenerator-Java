...
@XmlType(name = "JobFunctionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "code",
    "otherCodeList"
})
public class JobFunctionType {
    ...
    protected JobFunctionType.Code code;
     ...
     * @return
     *     possible object is
     *     {@link JobFunctionType.Code }
     *     
     */
    public JobFunctionType.Code getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(JobFunctionType.Code value) {
        this.code = value;
    }
