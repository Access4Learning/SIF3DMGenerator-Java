...
@XmlType(name = "TimetablePeriodType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "identifier",
    "name"
})
public class TimetablePeriodType {

    @XmlElement(name = "Identifier", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
