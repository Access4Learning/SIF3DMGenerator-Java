 ...
 *         &lt;element name="schoolRefId" type="{http://www.sifassociation.org/datamodel/na/4.x}gRefIdPointerType" minOccurs="0"/>
 *         &lt;element name="jobFunction" type="{http://www.sifassociation.org/datamodel/na/4.x}xEducationStaffClassificationType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "xStaffPersonAssignmentType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "leaRefId",
    "schoolRefId",
    "jobFunction"
})
