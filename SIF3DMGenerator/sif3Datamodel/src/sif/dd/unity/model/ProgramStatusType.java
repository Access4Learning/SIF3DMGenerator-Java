...
@XmlType(name = "ProgramStatusType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "code",
    "otherCodeList"
})
public class ProgramStatusType {
    ...
    protected ProgramStatusType.Code code;
     ...
     * @return
     *     possible object is
     *     {@link ProgramStatusType.Code }
     *     
     */
    public ProgramStatusType.Code getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(ProgramStatusType.Code value) {
        this.code = value;
    }
