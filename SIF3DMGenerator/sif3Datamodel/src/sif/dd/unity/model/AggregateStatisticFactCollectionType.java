 ...
 *       &lt;sequence>
 *         &lt;element name="AggregateStatisticFact" type="{http://www.sifassociation.org/datamodel/na/4.x}AggregateStatisticFactType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AggregateStatisticFactCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "aggregateStatisticFact"
})
public class AggregateStatisticFactCollectionType {

    @XmlElement(name = "AggregateStatisticFact", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
