 ...
 *       &lt;sequence>
 *         &lt;element name="LearningResourcePackage" type="{http://www.sifassociation.org/datamodel/na/4.x}LearningResourcePackageType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LearningResourcePackageCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "learningResourcePackage"
})
public class LearningResourcePackageCollectionType {

    @XmlElement(name = "LearningResourcePackage", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
