...
@XmlType(name = "ModifiedType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "by",
    "dateTime",
    "description"
})
public class ModifiedType {
    ...
    @XmlElement(name = "By", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
