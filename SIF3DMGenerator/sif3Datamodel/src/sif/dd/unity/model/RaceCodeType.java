...
/**
 * <p>Java class for RaceCodeType complex type.
 * 
...
@XmlType(name = "RaceCodeType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "code",
    "otherCodeList",
    "proportion"
})
public class RaceCodeType {
    ...
    protected RaceCodeType.Code code;
    ...
    @XmlElement(name = "Proportion", namespace = "http://www.sifassociation.org/datamodel/na/4.x", nillable = true)
     ...
     * @return
     *     possible object is
     *     {@link RaceCodeType.Code }
     *     
     */
    public RaceCodeType.Code getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(RaceCodeType.Code value) {
        this.code = value;
    }
