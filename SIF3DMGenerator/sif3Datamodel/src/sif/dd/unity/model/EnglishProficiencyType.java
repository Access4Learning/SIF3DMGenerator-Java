...
@XmlType(name = "EnglishProficiencyType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "code",
    "otherCodeList"
})
public class EnglishProficiencyType {
    ...
    protected EnglishProficiencyType.Code code;
     ...
     *     
     */
    public EnglishProficiencyType.Code getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(EnglishProficiencyType.Code value) {
        this.code = value;
    }
