 ...
 *       &lt;sequence>
 *         &lt;element name="GradingAssignmentScore" type="{http://www.sifassociation.org/datamodel/na/4.x}GradingAssignmentScoreType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GradingAssignmentScoreCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "gradingAssignmentScore"
})
public class GradingAssignmentScoreCollectionType {

    @XmlElement(name = "GradingAssignmentScore", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
