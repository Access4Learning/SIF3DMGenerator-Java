 ...
 *       &lt;sequence>
 *         &lt;element name="SchoolContact" type="{http://www.sifassociation.org/datamodel/na/4.x}SchoolContactType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SchoolContactListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "schoolContact"
})
public class SchoolContactListType {

    @XmlElement(name = "SchoolContact", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
