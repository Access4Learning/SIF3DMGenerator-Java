 ...
 *       &lt;sequence>
 *         &lt;element name="StudentPersonalRefId" type="{http://www.sifassociation.org/datamodel/na/4.x}IdRefType"/>
 ...
 *         &lt;element name="Grade" type="{http://www.sifassociation.org/datamodel/na/4.x}StudentGradeGradeType"/>
...
@XmlType(name = "StudentGradeType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
...
public class StudentGradeType {
    ...
    @XmlElement(name = "StudentPersonalRefId", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
    ...
    @XmlElement(name = "Grade", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
    protected StudentGradeGradeType grade;
     ...
     * @return
     *     possible object is
     *     {@link StudentGradeGradeType }
     *     
     */
    public StudentGradeGradeType getGrade() {
        return grade;
    }
     ...
     *     
     */
    public void setGrade(StudentGradeGradeType value) {
        this.grade = value;
    }
