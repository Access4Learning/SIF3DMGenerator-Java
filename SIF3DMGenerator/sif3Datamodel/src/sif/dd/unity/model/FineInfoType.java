 ...
 *       &lt;sequence>
 *         &lt;element name="Assessed" type="{http://www.w3.org/2001/XMLSchema}dateTime"/>
...
@XmlType(name = "FineInfoType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "assessed",
    "description",
    "amount",
    "reference"
...
public class FineInfoType {
    ...
    @XmlElement(name = "Assessed", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true, type = String.class)
    ...
    @XmlElement(name = "Reference", namespace = "http://www.sifassociation.org/datamodel/na/4.x", nillable = true)
