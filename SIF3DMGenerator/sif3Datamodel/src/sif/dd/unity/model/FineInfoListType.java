 ...
 *       &lt;sequence>
 *         &lt;element name="FineInfo" type="{http://www.sifassociation.org/datamodel/na/4.x}FineInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FineInfoListType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "fineInfo"
})
public class FineInfoListType {

    @XmlElement(name = "FineInfo", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
