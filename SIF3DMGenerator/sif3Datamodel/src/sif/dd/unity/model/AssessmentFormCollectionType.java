 ...
 *       &lt;sequence>
 *         &lt;element name="AssessmentForm" type="{http://www.sifassociation.org/datamodel/na/4.x}AssessmentFormType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AssessmentFormCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "assessmentForm"
})
public class AssessmentFormCollectionType {

    @XmlElement(name = "AssessmentForm", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
