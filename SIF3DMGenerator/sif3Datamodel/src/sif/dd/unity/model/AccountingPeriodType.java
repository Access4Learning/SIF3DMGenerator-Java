 ...
 *         &lt;element name="FiscalYearRefId" type="{http://www.sifassociation.org/datamodel/na/4.x}IdRefType"/>
...
@XmlType(name = "AccountingPeriodType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "name",
    "description",
    "fiscalYearRefId",
    "startDate",
...
public class AccountingPeriodType {
    ...
    @XmlElement(name = "FiscalYearRefId", namespace = "http://www.sifassociation.org/datamodel/na/4.x", required = true)
