 ...
 *       &lt;sequence>
 *         &lt;element name="MarkValueInfo" type="{http://www.sifassociation.org/datamodel/na/4.x}MarkValueInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "MarkValueInfoCollectionType", namespace = "http://www.sifassociation.org/datamodel/na/4.x", propOrder = {
    "markValueInfo"
})
public class MarkValueInfoCollectionType {

    @XmlElement(name = "MarkValueInfo", namespace = "http://www.sifassociation.org/datamodel/na/4.x")
