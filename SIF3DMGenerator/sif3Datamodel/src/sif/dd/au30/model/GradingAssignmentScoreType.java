 ...
 *         &lt;element name="StudentPersonalLocalId" type="{http://www.sifassociation.org/au/datamodel/3.4}LocalIdType" minOccurs="0"/>
 ...
 *         &lt;element name="GradingAssignmentRefId" type="{http://www.sifassociation.org/au/datamodel/3.4}IdRefType" minOccurs="0"/>
...
@XmlType(name = "GradingAssignmentScoreType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
...
public class GradingAssignmentScoreType {
    ...
    @XmlElement(name = "StudentPersonalLocalId", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    ...
    @XmlElement(name = "GradingAssignmentRefId", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String gradingAssignmentRefId;
    @XmlElementRef(name = "ScorePoints", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> scorePoints;
    @XmlElementRef(name = "ScorePercent", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> scorePercent;
    @XmlElementRef(name = "ScoreLetter", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> scoreLetter;
    @XmlElementRef(name = "ScoreDescription", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
