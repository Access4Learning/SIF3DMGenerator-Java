...
@XmlType(name = "DomainBandsContainerType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "band1Lower",
    "band1Upper",
    "band2Lower",
    "band2Upper",
...
public class DomainBandsContainerType {
    ...
    @XmlElement(name = "Band1Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band1Lower;
    @XmlElement(name = "Band1Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band1Upper;
    @XmlElement(name = "Band2Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band2Lower;
    @XmlElement(name = "Band2Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band2Upper;
    @XmlElement(name = "Band3Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band3Lower;
    @XmlElement(name = "Band3Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band3Upper;
    @XmlElement(name = "Band4Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band4Lower;
    @XmlElement(name = "Band4Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band4Upper;
    @XmlElement(name = "Band5Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band5Lower;
    @XmlElement(name = "Band5Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band5Upper;
    @XmlElement(name = "Band6Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band6Lower;
    @XmlElement(name = "Band6Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band6Upper;
    @XmlElement(name = "Band7Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band7Lower;
    @XmlElement(name = "Band7Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band7Upper;
    @XmlElement(name = "Band8Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band8Lower;
    @XmlElement(name = "Band8Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band8Upper;
    @XmlElement(name = "Band9Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band9Lower;
    @XmlElement(name = "Band9Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band9Upper;
    @XmlElement(name = "Band10Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal band10Lower;
    @XmlElement(name = "Band10Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
