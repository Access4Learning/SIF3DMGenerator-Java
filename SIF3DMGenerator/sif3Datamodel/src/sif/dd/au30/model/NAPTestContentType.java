 ...
 *         &lt;element name="TestLevel" type="{http://www.sifassociation.org/datamodel/au/3.4.1}YearLevelType"/>
 *         &lt;element name="TestType" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsNAPTestTypeType"/>
 *         &lt;element name="Domain" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsNAPTestDomainType"/>
 *         &lt;element name="TestYear" type="{http://www.sifassociation.org/datamodel/au/3.4.1}SchoolYearType"/>
 *         &lt;element name="StagesCount" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="DomainBands" type="{http://www.sifassociation.org/datamodel/au/3.4.1}DomainBandsContainerType"/>
 *         &lt;element name="DomainProficiency" type="{http://www.sifassociation.org/datamodel/au/3.4.1}DomainProficiencyContainerType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "NAPTestContentType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "napTestLocalId",
    "testName",
    "testLevel",
    "testType",
...
public class NAPTestContentType {
    ...
    @XmlElement(name = "TestName", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String testName;
    @XmlElement(name = "TestLevel", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected YearLevelType testLevel;
    @XmlElement(name = "TestType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected AUCodeSetsNAPTestTypeType testType;
    @XmlElement(name = "Domain", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected AUCodeSetsNAPTestDomainType domain;
    @XmlElement(name = "TestYear", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected XMLGregorianCalendar testYear;
    @XmlElement(name = "StagesCount", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1")
    protected int stagesCount;
    @XmlElement(name = "DomainBands", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected DomainBandsContainerType domainBands;
    @XmlElement(name = "DomainProficiency", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
