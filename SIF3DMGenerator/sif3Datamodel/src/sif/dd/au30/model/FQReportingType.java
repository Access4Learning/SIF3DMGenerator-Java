 ...
 *       &lt;sequence>
 *         &lt;element name="FQRefId" type="{http://www.sifassociation.org/datamodel/au/3.4}IdRefType" minOccurs="0"/>
...
public class FQReportingType {
    ...
    @XmlElementRef(name = "FQRefId", namespace = "http://www.sifassociation.org/datamodel/au/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fqRefId;
    ...
    /**
     * Gets the value of the fqRefId property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getFQRefId() {
        return fqRefId;
    }

    /**
     * Sets the value of the fqRefId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setFQRefId(JAXBElement<String> value) {
        this.fqRefId = value;
    }
