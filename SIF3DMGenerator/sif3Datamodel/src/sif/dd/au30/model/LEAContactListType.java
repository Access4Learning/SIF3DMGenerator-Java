 ...
 *       &lt;sequence>
 *         &lt;element name="LEAContact" type="{http://www.sifassociation.org/datamodel/au/3.4.1}LEAContactType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LEAContactListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "leaContact"
})
public class LEAContactListType {

    @XmlElement(name = "LEAContact", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
