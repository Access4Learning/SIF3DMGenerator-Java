 ...
 *       &lt;sequence>
 *         &lt;element name="CreationUser" type="{http://www.sifassociation.org/datamodel/au/3.4.1}CreationUserType"/>
...
@XmlType(name = "AuditInfoType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "creationUser",
    "creationDateTime"
})
public class AuditInfoType {

    @XmlElement(name = "CreationUser", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected CreationUserType creationUser;
    @XmlElement(name = "CreationDateTime", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true, type = String.class)
