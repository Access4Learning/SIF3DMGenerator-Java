 ...
 *       &lt;sequence>
 *         &lt;element name="StudentSubjectChoice" type="{http://www.sifassociation.org/datamodel/au/3.4.1}StudentSubjectChoiceType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentSubjectChoiceListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "studentSubjectChoice"
})
public class StudentSubjectChoiceListType {

    @XmlElement(name = "StudentSubjectChoice", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
