 ...
 *       &lt;sequence>
 *         &lt;element name="Name" type="{http://www.sifassociation.org/datamodel/au/3.4.1}NameType"/>
...
@XmlType(name = "ContactInfoType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "name",
    "positionTitle",
    "role",
    "address",
...
public class ContactInfoType {
    ...
    @XmlElementRef(name = "PositionTitle", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
