...
@XmlType(name = "DomainProficiencyContainerType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "level1Lower",
    "level1Upper",
    "level2Lower",
    "level2Upper",
...
public class DomainProficiencyContainerType {
    ...
    @XmlElement(name = "Level1Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal level1Lower;
    @XmlElement(name = "Level1Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal level1Upper;
    @XmlElement(name = "Level2Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal level2Lower;
    @XmlElement(name = "Level2Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal level2Upper;
    @XmlElement(name = "Level3Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal level3Lower;
    @XmlElement(name = "Level3Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal level3Upper;
    @XmlElement(name = "Level4Lower", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected BigDecimal level4Lower;
    @XmlElement(name = "Level4Upper", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
