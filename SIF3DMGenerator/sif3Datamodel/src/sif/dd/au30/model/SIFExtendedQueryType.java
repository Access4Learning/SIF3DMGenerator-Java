...
@XmlType(name = "SIF_ExtendedQueryType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
...
public class SIFExtendedQueryType {
    ...
    @XmlElement(name = "SIF_DestinationProvider", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String sifDestinationProvider;
    @XmlElement(name = "SIF_Select", namespace = "http://www.sifassociation.org/au/datamodel/3.4", required = true)
    protected SIFExtendedQueryType.SIFSelect sifSelect;
    @XmlElement(name = "SIF_From", namespace = "http://www.sifassociation.org/au/datamodel/3.4", required = true)
    protected SIFExtendedQueryType.SIFFrom sifFrom;
    @XmlElement(name = "SIF_Where", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    protected SIFExtendedQueryType.SIFWhere sifWhere;
    @XmlElement(name = "SIF_OrderBy", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    ...
    public static class SIFFrom {
        ...
        public static class SIFJoin {
            ...
            @XmlElement(name = "SIF_JoinOn", namespace = "http://www.sifassociation.org/au/datamodel/3.4", required = true)
            ...
            public static class SIFJoinOn {
                ...
                @XmlElement(name = "SIF_LeftElement", namespace = "http://www.sifassociation.org/au/datamodel/3.4", required = true)
                protected SIFExtendedQueryType.SIFFrom.SIFJoin.SIFJoinOn.SIFLeftElement sifLeftElement;
                @XmlElement(name = "SIF_RightElement", namespace = "http://www.sifassociation.org/au/datamodel/3.4", required = true)
    ...
    public static class SIFWhere {
        ...
        @XmlElement(name = "SIF_ConditionGroup", namespace = "http://www.sifassociation.org/au/datamodel/3.4", required = true)
