 ...
 *       &lt;sequence>
 *         &lt;element name="Code" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsEnglishProficiencyType"/>
...
@XmlType(name = "EnglishProficiencyType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "code",
    "otherCodeList"
})
