 ...
 *       &lt;sequence>
 *         &lt;element name="YearLevelEnrollment" type="{http://www.sifassociation.org/datamodel/au/3.4.1}YearLevelEnrollmentType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "YearLevelEnrollmentListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "yearLevelEnrollment"
})
public class YearLevelEnrollmentListType {

    @XmlElement(name = "YearLevelEnrollment", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
