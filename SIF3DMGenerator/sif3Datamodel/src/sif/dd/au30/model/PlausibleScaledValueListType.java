...
@XmlType(name = "PlausibleScaledValueListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "plausibleScaledValue"
})
public class PlausibleScaledValueListType {

    @XmlElement(name = "PlausibleScaledValue", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
