 ...
 *       &lt;sequence>
 *         &lt;element name="TeachingGroupTeacher" type="{http://www.sifassociation.org/datamodel/au/3.4.1}TeachingGroupTeacherType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TeacherListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "teachingGroupTeacher"
})
public class TeacherListType {

    @XmlElement(name = "TeachingGroupTeacher", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
