 ...
 *         &lt;element name="CampusType" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsSchoolLevelType" minOccurs="0"/>
 *         &lt;element name="AdminStatus" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsYesOrNoCategoryType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CampusContainerType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "parentSchoolId",
    "schoolCampusId",
    "campusType",
    "adminStatus"
...
public class CampusContainerType {
    ...
    @XmlElementRef(name = "ParentSchoolId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> parentSchoolId;
    @XmlElement(name = "SchoolCampusId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String schoolCampusId;
    @XmlElementRef(name = "CampusType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsSchoolLevelType> campusType;
    @XmlElement(name = "AdminStatus", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
