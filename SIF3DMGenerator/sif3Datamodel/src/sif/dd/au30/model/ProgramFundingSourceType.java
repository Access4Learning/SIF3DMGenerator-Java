 ...
 *       &lt;sequence>
 *         &lt;element name="Code" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsProgramFundingSourceCodeType"/>
...
@XmlType(name = "ProgramFundingSourceType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "code",
    "otherCodeList"
})
