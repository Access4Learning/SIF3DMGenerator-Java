 ...
 *         &lt;element name="TermInfoRefId" type="{http://www.sifassociation.org/datamodel/au/3.4.1}IdRefType" minOccurs="0"/>
 *         &lt;element name="CourseCode" type="{http://www.w3.org/2001/XMLSchema}normalizedString"/>
 ...
 *         &lt;element name="SubjectAreaList" type="{http://www.sifassociation.org/datamodel/au/3.4.1}SubjectAreaListType" minOccurs="0"/>
 ...
 *         &lt;element name="CoreAcademicCourse" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
 *         &lt;element name="GraduationRequirement" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
...
@XmlType(name = "SchoolCourseInfoType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "schoolInfoRefId",
    "schoolLocalId",
    "schoolYear",
    "termInfoRefId",
...
public class SchoolCourseInfoType {
    ...
    @XmlElementRef(name = "TermInfoRefId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> termInfoRefId;
    @XmlElement(name = "CourseCode", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String courseCode;
    @XmlElementRef(name = "StateCourseCode", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> stateCourseCode;
    @XmlElementRef(name = "DistrictCourseCode", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> districtCourseCode;
    @XmlElementRef(name = "SubjectAreaList", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<SubjectAreaListType> subjectAreaList;
    @XmlElement(name = "CourseTitle", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    ...
    @XmlElementRef(name = "InstructionalLevel", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> instructionalLevel;
    @XmlElementRef(name = "CourseCredits", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> courseCredits;
    @XmlElementRef(name = "CoreAcademicCourse", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsYesOrNoCategoryType> coreAcademicCourse;
    @XmlElementRef(name = "GraduationRequirement", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsYesOrNoCategoryType> graduationRequirement;
    @XmlElementRef(name = "Department", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> department;
    @XmlElementRef(name = "CourseContent", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
