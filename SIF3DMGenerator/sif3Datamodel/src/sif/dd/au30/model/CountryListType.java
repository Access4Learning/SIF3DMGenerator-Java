 ...
 *       &lt;sequence>
 *         &lt;element name="CountryOfCitizenship" type="{http://www.sifassociation.org/datamodel/au/3.4.1}CountryType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CountryListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "countryOfCitizenship"
})
public class CountryListType {

    @XmlElement(name = "CountryOfCitizenship", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
