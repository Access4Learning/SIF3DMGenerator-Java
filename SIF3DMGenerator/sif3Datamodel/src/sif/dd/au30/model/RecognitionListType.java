 ...
 *       &lt;sequence>
 *         &lt;element name="Recognition" type="{http://www.w3.org/2001/XMLSchema}normalizedString" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RecognitionListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "recognition"
})
public class RecognitionListType {

    @XmlElement(name = "Recognition", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
