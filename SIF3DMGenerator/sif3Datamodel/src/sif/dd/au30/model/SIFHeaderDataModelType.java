 ...
 *       &lt;sequence>
 *         &lt;element name="SIF_MsgId" type="{http://www.sifassociation.org/au/datamodel/3.4}MsgIdType" minOccurs="0"/>
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element ref="{http://www.sifassociation.org/au/datamodel/3.4}SIF_AuthenticationLevel" minOccurs="0"/>
 *                             &lt;element ref="{http://www.sifassociation.org/au/datamodel/3.4}SIF_EncryptionLevel" minOccurs="0"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="SIF_Contexts" type="{http://www.sifassociation.org/au/datamodel/3.4}SIF_ContextsType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SIF_HeaderDataModelType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
    "sifMsgId",
    "sifTimestamp",
    "sifSecurity",
    "sifSourceId",
...
public class SIFHeaderDataModelType {
    ...
    @XmlElement(name = "SIF_MsgId", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String sifMsgId;
    @XmlElement(name = "SIF_Timestamp", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar sifTimestamp;
    @XmlElementRef(name = "SIF_Security", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<SIFHeaderDataModelType.SIFSecurity> sifSecurity;
    @XmlElement(name = "SIF_SourceId", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String sifSourceId;
    @XmlElementRef(name = "SIF_DestinationId", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sifDestinationId;
    @XmlElementRef(name = "SIF_Contexts", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    ...
    public static class SIFSecurity {
        ...
        @XmlElement(name = "SIF_SecureChannel", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
        ...
        public static class SIFSecureChannel {
            ...
            @XmlElement(name = "SIF_AuthenticationLevel", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
            protected Long sifAuthenticationLevel;
            @XmlElement(name = "SIF_EncryptionLevel", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
