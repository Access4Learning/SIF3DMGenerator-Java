 ...
 *       &lt;sequence>
 *         &lt;element name="HouseholdContactInfo" type="{http://www.sifassociation.org/datamodel/au/3.4.1}HouseholdContactInfoType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "HouseholdContactInfoListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "householdContactInfo"
})
public class HouseholdContactInfoListType {

    @XmlElement(name = "HouseholdContactInfo", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
