 ...
 *       &lt;sequence>
 *         &lt;element name="StudentAttendanceTimeList" type="{http://www.sifassociation.org/au/datamodel/3.4}StudentAttendanceTimeListType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentAttendanceTimeListCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
    "studentAttendanceTimeList"
})
public class StudentAttendanceTimeListCollectionType {

    @XmlElement(name = "StudentAttendanceTimeList", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
