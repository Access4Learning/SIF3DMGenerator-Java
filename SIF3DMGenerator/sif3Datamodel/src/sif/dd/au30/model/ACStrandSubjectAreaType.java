 ...
 *       &lt;sequence>
 *         &lt;element name="ACStrand" type="{http://www.sifassociation.org/au/datamodel/3.4}AUCodeSetsACStrandType" minOccurs="0"/>
...
@XmlType(name = "ACStrandSubjectAreaType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
    "acStrand",
    "subjectArea"
})
public class ACStrandSubjectAreaType {

    @XmlElement(name = "ACStrand", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
