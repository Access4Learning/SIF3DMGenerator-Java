 ...
 *         &lt;element name="ContactInfo" type="{http://www.sifassociation.org/datamodel/au/3.4.1}ContactInfoType" minOccurs="0"/>
 ...
 *         &lt;element name="RegisteredForGST" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
...
@XmlType(name = "VendorInfoType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "name",
    "contactInfo",
    "customerId",
    "abn",
...
public class VendorInfoType {
    ...
    @XmlElementRef(name = "ContactInfo", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<ContactInfoType> contactInfo;
    @XmlElementRef(name = "CustomerId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> customerId;
    @XmlElementRef(name = "ABN", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> abn;
    @XmlElementRef(name = "RegisteredForGST", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsYesOrNoCategoryType> registeredForGST;
    @XmlElementRef(name = "PaymentTerms", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> paymentTerms;
    @XmlElementRef(name = "BPay", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> bPay;
    @XmlElementRef(name = "BSB", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> bsb;
    @XmlElementRef(name = "AccountNumber", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> accountNumber;
    @XmlElementRef(name = "AccountName", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
