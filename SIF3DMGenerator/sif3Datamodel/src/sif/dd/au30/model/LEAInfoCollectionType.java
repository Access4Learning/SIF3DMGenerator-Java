 ...
 *       &lt;sequence>
 *         &lt;element name="LEAInfo" type="{http://www.sifassociation.org/datamodel/au/3.4.1}LEAInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LEAInfoCollectionType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "leaInfo"
})
public class LEAInfoCollectionType {

    @XmlElement(name = "LEAInfo", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1")
