 ...
 *       &lt;sequence>
 *         &lt;element name="VendorInfo" type="{http://www.sifassociation.org/datamodel/au/3.4.1}VendorInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "VendorInfoCollectionType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "vendorInfo"
})
public class VendorInfoCollectionType {

    @XmlElement(name = "VendorInfo", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1")
