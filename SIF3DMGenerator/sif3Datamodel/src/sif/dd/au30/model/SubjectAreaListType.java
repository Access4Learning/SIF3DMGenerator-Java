 ...
 *       &lt;sequence>
 *         &lt;element name="SubjectArea" type="{http://www.sifassociation.org/datamodel/au/3.4}SubjectAreaType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SubjectAreaListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4", propOrder = {
    "subjectArea"
})
public class SubjectAreaListType {

    @XmlElement(name = "SubjectArea", namespace = "http://www.sifassociation.org/datamodel/au/3.4", required = true)
