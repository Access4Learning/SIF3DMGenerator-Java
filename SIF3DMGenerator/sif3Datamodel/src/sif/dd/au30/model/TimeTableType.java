 ...
 *         &lt;element name="TimeTableDayList" type="{http://www.sifassociation.org/datamodel/au/3.4.1}TimeTableDayListType"/>
...
@XmlType(name = "TimeTableType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "schoolInfoRefId",
    "schoolYear",
    "localId",
    "title",
...
public class TimeTableType {
    ...
    @XmlElement(name = "DaysPerCycle", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1")
    @XmlSchemaType(name = "unsignedInt")
    protected long daysPerCycle;
    @XmlElement(name = "PeriodsPerDay", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1")
    @XmlSchemaType(name = "unsignedInt")
    protected long periodsPerDay;
    @XmlElementRef(name = "TeachingPeriodsPerDay", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "SchoolName", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> schoolName;
    @XmlElementRef(name = "TimeTableCreationDate", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    ...
    @XmlElement(name = "TimeTableDayList", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
