 ...
 *       &lt;sequence>
 *         &lt;element name="ContactName" type="{http://www.sifassociation.org/datamodel/au/3.4.1}NameOfRecordType"/>
...
@XmlType(name = "PrincipalInfoType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "contactName",
    "contactTitle",
    "phoneNumberList",
    "emailList"
...
public class PrincipalInfoType {
    ...
    @XmlElement(name = "ContactName", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected NameOfRecordType contactName;
    @XmlElementRef(name = "ContactTitle", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
