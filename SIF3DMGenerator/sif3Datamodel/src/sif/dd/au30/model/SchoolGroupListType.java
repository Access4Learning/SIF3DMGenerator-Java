 ...
 *       &lt;sequence>
 *         &lt;element name="SchoolGroup" type="{http://www.sifassociation.org/datamodel/au/3.4}LocalIdType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SchoolGroupListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4", propOrder = {
    "schoolGroup"
})
public class SchoolGroupListType {

    @XmlElement(name = "SchoolGroup", namespace = "http://www.sifassociation.org/datamodel/au/3.4", required = true)
