 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="FormNumber" type="{http://www.sifassociation.org/datamodel/au/3.4.1}LocalIdType" minOccurs="0"/>
 ...
 *         &lt;element name="BilledAmount" type="{http://www.sifassociation.org/datamodel/au/3.4.1}DebitOrCreditAmountType"/>
 *         &lt;element name="Ledger">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}token">
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="ChargedLocationInfoRefId" type="{http://www.sifassociation.org/datamodel/au/3.4.1}IdRefType" minOccurs="0"/>
 *         &lt;element name="NetAmount" type="{http://www.sifassociation.org/datamodel/au/3.4.1}MonetaryAmountType" minOccurs="0"/>
 ...
 *         &lt;element name="TaxAmount" type="{http://www.sifassociation.org/datamodel/au/3.4.1}MonetaryAmountType" minOccurs="0"/>
 ...
 *         &lt;element name="FinancialAccountRefIdList" type="{http://www.sifassociation.org/datamodel/au/3.4.1}FinancialAccountRefIdListType" minOccurs="0"/>
 *         &lt;element name="AccountingPeriod" type="{http://www.sifassociation.org/datamodel/au/3.4.1}LocalIdType" minOccurs="0"/>
 *         &lt;element name="RelatedPurchaseOrderRefId" type="{http://www.sifassociation.org/datamodel/au/3.4.1}IdRefType" minOccurs="0"/>
 *         &lt;element name="PurchasingItems" type="{http://www.sifassociation.org/datamodel/au/3.4.1}PurchasingItemsType" minOccurs="0"/>
 *         &lt;element name="Voluntary" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
...
@XmlType(name = "InvoiceType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "invoicedEntity",
    "formNumber",
    "billingDate",
...
public class InvoiceType {
    ...
    @XmlElement(name = "InvoicedEntity", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected InvoiceType.InvoicedEntity invoicedEntity;
    @XmlElementRef(name = "FormNumber", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> formNumber;
    @XmlElement(name = "BillingDate", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar billingDate;
    @XmlElement(name = "TransactionDescription", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String transactionDescription;
    @XmlElement(name = "BilledAmount", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected DebitOrCreditAmountType billedAmount;
    @XmlElement(name = "Ledger", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String ledger;
    @XmlElementRef(name = "ChargedLocationInfoRefId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> chargedLocationInfoRefId;
    @XmlElementRef(name = "NetAmount", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<MonetaryAmountType> netAmount;
    @XmlElementRef(name = "TaxRate", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> taxRate;
    @XmlElementRef(name = "TaxType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> taxType;
    @XmlElementRef(name = "TaxAmount", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<MonetaryAmountType> taxAmount;
    @XmlElementRef(name = "CreatedBy", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> createdBy;
    @XmlElementRef(name = "ApprovedBy", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> approvedBy;
    @XmlElementRef(name = "ItemDetail", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "FinancialAccountRefIdList", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "RelatedPurchaseOrderRefId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> relatedPurchaseOrderRefId;
    @XmlElementRef(name = "PurchasingItems", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<PurchasingItemsType> purchasingItems;
    @XmlElementRef(name = "Voluntary", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
