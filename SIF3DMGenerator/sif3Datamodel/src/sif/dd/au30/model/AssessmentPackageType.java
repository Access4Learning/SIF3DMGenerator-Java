...
@XmlType(name = "AssessmentPackageType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
    "xmlData",
    "sifMetadata",
    "sifExtendedElements"
})
public class AssessmentPackageType {
    ...
    @XmlElementRef(name = "XMLData", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
