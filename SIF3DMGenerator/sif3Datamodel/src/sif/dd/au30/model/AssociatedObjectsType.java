...
public class AssociatedObjectsType {
     ...
     * {@link AssociatedObjectsType.AssociatedObject }
     * 
     * 
     */
    public List<AssociatedObjectsType.AssociatedObject> getAssociatedObject() {
        if (associatedObject == null) {
            associatedObject = new ArrayList<AssociatedObjectsType.AssociatedObject>();
        }
