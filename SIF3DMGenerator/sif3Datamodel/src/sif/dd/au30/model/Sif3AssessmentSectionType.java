 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="SectionAsset" type="{http://www.sifassociation.org/au/datamodel/3.4}IdRefType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "Sif3AssessmentSectionType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
    "sectionVersion",
    "sectionPublishDate",
    "sectionIdentifiers",
    "sectionName",
...
public class Sif3AssessmentSectionType {
    ...
    @XmlElementRef(name = "SectionVersion", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sectionVersion;
    @XmlElementRef(name = "SectionPublishDate", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Calendar> sectionPublishDate;
    @XmlElementRef(name = "SectionIdentifiers", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Sif3AssessmentSectionType.SectionIdentifiers> sectionIdentifiers;
    @XmlElementRef(name = "SectionName", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sectionName;
    @XmlElement(name = "SectionItemSequenceType", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String sectionItemSequenceType;
    @XmlElementRef(name = "ItemSelectionAlgorithmName", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> itemSelectionAlgorithmName;
    @XmlElementRef(name = "ItemSelectionAlgorithm", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> itemSelectionAlgorithm;
    @XmlElementRef(name = "SectionTimeLimit", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Duration> sectionTimeLimit;
    @XmlElementRef(name = "SectionSealed", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sectionSealed;
    @XmlElementRef(name = "SectionReentry", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sectionReentry;
    @XmlElementRef(name = "SectionAssets", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Sif3AssessmentSectionType.SectionAssets> sectionAssets;
    @XmlElementRef(name = "SectionItems", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    ...
    public static class SectionAssets {
        ...
        @XmlElement(name = "SectionAsset", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    public static class SectionIdentifiers {
        ...
        @XmlElement(name = "SectionIdentifier", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    ...
    public static class SectionItems {
        ...
        @XmlElement(name = "SectionItem", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
        ...
        public static class SectionItem {
            ...
            @XmlElementRef(name = "ItemSequence", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
