 ...
 *       &lt;sequence>
 *         &lt;element name="Code" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AUCodeSetsActivityInvolvementCodeType"/>
...
@XmlType(name = "StudentActivityType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "code",
    "otherCodeList"
})
