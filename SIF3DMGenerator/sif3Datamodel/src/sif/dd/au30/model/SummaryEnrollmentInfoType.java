 ...
 *                             &lt;element name="SchoolStateProvinceId" type="{http://www.sifassociation.org/au/datamodel/3.4}StateProvinceIdType" minOccurs="0"/>
 *                             &lt;element name="Student" minOccurs="0">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 *                                       &lt;element name="StudentSchoolEnrollmentRefId" type="{http://www.sifassociation.org/au/datamodel/3.4}RefIdType" minOccurs="0"/>
 ...
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 *                                       &lt;element name="StaffAssignmentRefId" type="{http://www.sifassociation.org/au/datamodel/3.4}RefIdType" minOccurs="0"/>
...
@XmlType(name = "SummaryEnrollmentInfoType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
    "schoolYear",
    "parentObjectRefId",
    "localId",
    "stateProvinceId",
...
public class SummaryEnrollmentInfoType {
    ...
    @XmlElement(name = "ParentObjectRefId", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    ...
    @XmlElement(name = "SchoolEnrollmentList", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    ...
    public static class SchoolEnrollmentList {
        ...
        @XmlElement(name = "SchoolEnrollment", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
        ...
        public static class SchoolEnrollment {
            ...
            @XmlElementRef(name = "SchoolStateProvinceId", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
            protected JAXBElement<String> schoolStateProvinceId;
            @XmlElementRef(name = "Student", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
            protected JAXBElement<SummaryEnrollmentInfoType.SchoolEnrollmentList.SchoolEnrollment.Student> student;
            @XmlElementRef(name = "Staff", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
            protected JAXBElement<SummaryEnrollmentInfoType.SchoolEnrollmentList.SchoolEnrollment.Staff> staff;
            @XmlElementRef(name = "EnrollmentList", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
            ...
            public static class EnrollmentList {
                ...
                public static class Enrollment {
                    ...
                    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
                    protected String localId;
                    @XmlElementRef(name = "ShortName", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
            ...
            public static class Staff {
                ...
                @XmlElement(name = "StaffAssignmentRefId", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
                @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
            ...
            public static class Student {
                ...
                @XmlElement(name = "StudentSchoolEnrollmentRefId", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
                @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
                protected String studentSchoolEnrollmentRefId;
                @XmlElementRef(name = "StudentLocalId", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
