 ...
 *         &lt;element name="RichDescription" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AbstractContentElementType" minOccurs="0"/>
 *         &lt;element name="Source">
 *           &lt;simpleType>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="Organizations" type="{http://www.sifassociation.org/datamodel/au/3.4.1}OrganizationsType"/>
 *         &lt;element name="Authors" type="{http://www.sifassociation.org/datamodel/au/3.4.1}AuthorsType" minOccurs="0"/>
 *         &lt;element name="OrganizationContactPoint" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="SubjectAreas" type="{http://www.sifassociation.org/datamodel/au/3.4.1}ACStrandAreaListType"/>
 ...
 *         &lt;element name="LearningStandardItemRefId" type="{http://www.sifassociation.org/datamodel/au/3.4.1}IdRefType"/>
 *         &lt;element name="RelatedLearningStandards" type="{http://www.sifassociation.org/datamodel/au/3.4.1}LearningStandardsDocumentType" minOccurs="0"/>
...
@XmlType(name = "LearningStandardDocumentType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "title",
    "description",
    "richDescription",
    "source",
...
public class LearningStandardDocumentType {
    ...
    @XmlElementRef(name = "RichDescription", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<AbstractContentElementType> richDescription;
    @XmlElement(name = "Source", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String source;
    @XmlElement(name = "Organizations", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected OrganizationsType organizations;
    @XmlElementRef(name = "Authors", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<AuthorsType> authors;
    @XmlElementRef(name = "OrganizationContactPoint", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> organizationContactPoint;
    @XmlElement(name = "SubjectAreas", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    protected ACStrandAreaListType subjectAreas;
    @XmlElement(name = "DocumentStatus", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String documentStatus;
    @XmlElementRef(name = "DocumentDate", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> documentDate;
    @XmlElementRef(name = "LocalAdoptionDate", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> localAdoptionDate;
    @XmlElementRef(name = "LocalArchiveDate", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> localArchiveDate;
    @XmlElementRef(name = "EndOfLifeDate", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> endOfLifeDate;
    @XmlElementRef(name = "Copyright", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "RepositoryDate", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> repositoryDate;
    @XmlElement(name = "LearningStandardItemRefId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String learningStandardItemRefId;
    @XmlElementRef(name = "RelatedLearningStandards", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    ...
    public static class Copyright {
        ...
        @XmlElementRef(name = "Holder", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
