 ...
 *       &lt;sequence>
 *         &lt;element name="ItemResponse" type="{http://www.sifassociation.org/datamodel/au/3.4.1}NAPTestletResponseItemType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "NAPTestletItemResponseListType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "itemResponse"
})
public class NAPTestletItemResponseListType {

    @XmlElement(name = "ItemResponse", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
