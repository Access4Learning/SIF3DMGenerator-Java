 ...
 *         &lt;element name="Definition" type="{http://www.w3.org/2001/XMLSchema}token"/>
...
@XmlType(name = "AggregateCharacteristicInfoType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "description",
    "definition",
    "elementName",
    "sifMetadata",
...
public class AggregateCharacteristicInfoType {
    ...
    @XmlElement(name = "Definition", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String definition;
    @XmlElementRef(name = "ElementName", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
