...
@XmlType(name = "AggregateCharacteristicInfoType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
    "description",
    "definition",
    "elementName",
    "sifMetadata",
...
public class AggregateCharacteristicInfoType {
    ...
    @XmlElement(name = "Definition", namespace = "http://www.sifassociation.org/au/datamodel/3.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String definition;
    @XmlElementRef(name = "ElementName", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
