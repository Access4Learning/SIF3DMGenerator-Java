 ...
 *         &lt;element name="AssetNumber" type="{http://www.sifassociation.org/au/datamodel/3.4}LocalIdType" minOccurs="0"/>
 *         &lt;element name="InvoiceRefId" type="{http://www.sifassociation.org/au/datamodel/3.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="PurchaseOrderRefId" type="{http://www.sifassociation.org/au/datamodel/3.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="EquipmentType" minOccurs="0">
 *           &lt;simpleType>
 *             &lt;union memberTypes=" {http://www.sifassociation.org/au/datamodel/3.4}AUCodeSetsEquipmentTypeType {http://www.w3.org/2001/XMLSchema}token">
 *             &lt;/union>
 *           &lt;/simpleType>
 *         &lt;/element>
...
@XmlType(name = "EquipmentInfoType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", propOrder = {
    "name",
    "description",
    "localId",
    "assetNumber",
...
public class EquipmentInfoType {
    ...
    @XmlElementRef(name = "AssetNumber", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PurchaseOrderRefId", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> purchaseOrderRefId;
    @XmlElementRef(name = "EquipmentType", namespace = "http://www.sifassociation.org/au/datamodel/3.4", type = JAXBElement.class, required = false)
