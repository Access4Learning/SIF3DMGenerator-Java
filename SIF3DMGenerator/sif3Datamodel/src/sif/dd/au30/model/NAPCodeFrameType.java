 ...
 *       &lt;sequence>
 *         &lt;element name="NAPTestRefId" type="{http://www.sifassociation.org/datamodel/au/3.4.1}IdRefType"/>
 *         &lt;element name="TestContent" type="{http://www.sifassociation.org/datamodel/au/3.4.1}NAPTestContentType"/>
 *         &lt;element name="TestletList" type="{http://www.sifassociation.org/datamodel/au/3.4.1}NAPCodeFrameTestletListType"/>
...
@XmlType(name = "NAPCodeFrameType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "napTestRefId",
    "testContent",
    "testletList",
    "sifMetadata",
...
public class NAPCodeFrameType {
    ...
    @XmlElement(name = "NAPTestRefId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
