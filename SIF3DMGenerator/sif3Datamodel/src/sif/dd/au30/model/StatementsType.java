...
@XmlType(name = "StatementsType", namespace = "http://www.sifassociation.org/datamodel/au/3.4", propOrder = {
    "statement"
})
public class StatementsType {

    @XmlElement(name = "Statement", namespace = "http://www.sifassociation.org/datamodel/au/3.4", required = true)
