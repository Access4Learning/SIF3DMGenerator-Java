 ...
 *       &lt;sequence>
 *         &lt;element name="SubjectLocalId" type="{http://www.sifassociation.org/datamodel/au/3.4.1}LocalIdType"/>
 *         &lt;element name="AcademicYear" type="{http://www.sifassociation.org/datamodel/au/3.4.1}YearLevelType" minOccurs="0"/>
 *         &lt;element name="AcademicYearRange" type="{http://www.sifassociation.org/datamodel/au/3.4.1}YearRangeType" minOccurs="0"/>
 *         &lt;element name="CourseLocalId" type="{http://www.sifassociation.org/datamodel/au/3.4.1}LocalIdType" minOccurs="0"/>
...
@XmlType(name = "TimeTableSubjectType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", propOrder = {
    "subjectLocalId",
    "academicYear",
    "academicYearRange",
    "courseLocalId",
...
public class TimeTableSubjectType {
    ...
    @XmlElement(name = "SubjectLocalId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String subjectLocalId;
    @XmlElementRef(name = "AcademicYear", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<YearLevelType> academicYear;
    @XmlElementRef(name = "AcademicYearRange", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<YearRangeType> academicYearRange;
    @XmlElementRef(name = "CourseLocalId", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Faculty", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> faculty;
    @XmlElementRef(name = "SubjectShortName", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> subjectShortName;
    @XmlElement(name = "SubjectLongName", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String subjectLongName;
    @XmlElementRef(name = "SubjectType", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<String> subjectType;
    @XmlElementRef(name = "ProposedMaxClassSize", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> proposedMaxClassSize;
    @XmlElementRef(name = "ProposedMinClassSize", namespace = "http://www.sifassociation.org/datamodel/au/3.4.1", type = JAXBElement.class, required = false)
