 ...
 *         &lt;element name="StimulusList" type="{http://www.sifassociation.org/datamodel/au/3.4}StimulusListType" minOccurs="0"/>
 *         &lt;element name="NAPWritingRubricList" type="{http://www.sifassociation.org/datamodel/au/3.4}NAPWritingRubricListType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "NAPTestItemContentType", namespace = "http://www.sifassociation.org/datamodel/au/3.4", propOrder = {
    "napTestItemLocalId",
    "itemName",
    "itemType",
    "subdomain",
...
public class NAPTestItemContentType {
    ...
    @XmlElementRef(name = "ContentDescriptionList", namespace = "http://www.sifassociation.org/datamodel/au/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ContentDescriptionListType> contentDescriptionList;
    @XmlElementRef(name = "StimulusList", namespace = "http://www.sifassociation.org/datamodel/au/3.4", type = JAXBElement.class, required = false)
    protected JAXBElement<StimulusListType> stimulusList;
    @XmlElementRef(name = "NAPWritingRubricList", namespace = "http://www.sifassociation.org/datamodel/au/3.4", type = JAXBElement.class, required = false)
